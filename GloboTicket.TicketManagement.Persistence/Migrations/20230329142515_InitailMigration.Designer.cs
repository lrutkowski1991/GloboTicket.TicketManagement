...
namespace GloboTicket.TicketManagement.Persistence.Migrations
{
    ...
    [Migration("20230329142515_InitailMigration")]
            ...
            modelBuilder.Entity("GloboTicket.TicketManagement.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2023, 9, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2292),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2023, 12, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2336),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2023, 7, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2346),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2023, 7, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2355),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2024, 1, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2363),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2023, 11, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2374),
            ...
            modelBuilder.Entity("GloboTicket.TicketManagement.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 3, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2385),
                            OrderTotal = 400,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 3, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2396),
                            OrderTotal = 135,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 3, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2405),
                            OrderTotal = 85,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 3, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2413),
                            OrderTotal = 245,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 3, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2422),
                            OrderTotal = 142,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 3, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2431),
                            OrderTotal = 40,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 3, 29, 16, 25, 15, 773, DateTimeKind.Local).AddTicks(2440),
                            OrderTotal = 116,
                            UserId = new Guid("7aeb2c01-fe8e-4b84-a5ba-330bdf950f5c")
                        });
                });
